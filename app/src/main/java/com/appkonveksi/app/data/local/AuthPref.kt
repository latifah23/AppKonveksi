package com.appkonveksi.app.data.local

import android.content.Context
import android.content.SharedPreferences
import android.provider.ContactsContract
import com.appkonveksi.app.data.model.ActionState
import com.appkonveksi.app.data.model.AuthUser
import com.appkonveksi.app.util.getObject
import com.appkonveksi.app.util.putObject
...
class AuthPref (val context:Context){
    ...
    public set(value) = sp.edit().putObject(AUTH_USER, value).apply()
